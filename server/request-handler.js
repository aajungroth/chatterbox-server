...
module.exports = function(request, response) {
  ...
  if(request.method === 'GET'  && request.url === '/classes/messages') {
    ...
    request.on('end', function() {
      ...
      requestBody.objectId = Date.now();
      var dateTime = new Date();
      var formatted = dateTime.toISOString();
      requestBody.createdAt = formatted;
      requestBody.updatedAt = formatted;

      if (requestBody.hasOwnProperty('roomName') === false) {
        requestBody.roomName = 'lobby';
      }
      console.log('requestBody after', requestBody);
